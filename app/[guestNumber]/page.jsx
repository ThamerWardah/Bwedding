...
export default function Light(){
  ...
  en: {
    ...
    groom: 'Ali',
    bride: 'Fatima',
    message: 'In this night, our dream is completed and our love story is crowned. Join us as witnesses to our joy.',
    date: 'Friday, February 19, 2026',
    time: '7:00 PM',
    location: 'Basra - Grand Millennium Al Seef Hotel Hall',
    countdown: 'Countdown to the Wedding Day',
    finished: 'The awaited day has arrived 🎉',
    rsvp: 'Confirm Attendance',
    updateRsvp: 'Update Attendance',
    switch: 'العربية',
    days: 'Days',
    hours: 'Hours',
    minutes: 'Minutes',
    seconds: 'Seconds',
    quote: 'With you, my other half is complete, and with your love, my existence is complete',
